...
export default function DownloadSection({ matchId, cvName }: DownloadSectionProps) {
  return (
    <section className="mb-12">
      <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-gray-100">
        <h2 className="text-2xl font-black text-secondary mb-6 text-center">
          Save Your Match Report
        </h2>
        <p className="text-gray-600 text-center mb-8">
          Download comprehensive analysis for offline review
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="text-center hover:scale-105 transition-transform cursor-pointer">
            ...
            <p className="text-sm text-gray-600 mb-4 leading-relaxed">
              Comprehensive 15-page PDF with match analysis, keyword gaps, strengths, weaknesses, action plan
            </p>
            <p className="text-xs text-gray-500 mb-4">~3.2 MB</p>
          ...
          <div className="text-center hover:scale-105 transition-transform cursor-pointer">
            ...
            <p className="text-sm text-gray-600 mb-4 leading-relaxed">
              Printable checklist of all changes to make, sorted by priority with time estimates
            </p>
            <p className="text-xs text-gray-500 mb-4">~400 KB</p>
